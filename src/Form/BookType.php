...
class BookType extends AbstractType
{
    ...
    // du BookType créé précédemment on ajoute l'input author (la colonne author est reliée à plusieurs colonnes
    ...
    //   get+le nom du champs. Entre 2 points on crée un espace pour séparer les données des différentes colonnes.
    //
